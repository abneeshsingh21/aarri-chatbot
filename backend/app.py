...
# Supports: localhost (dev), GitHub Pages, and any custom domain
cors_origins = [
    "http://localhost:3000",
    "http://localhost:5000",
    "http://127.0.0.1:3000",
    ...
    "https://aarii-backend.onrender.com",  # Your Render backend (self-reference for testing)
    os.getenv("FRONTEND_URL", "*"),  # Allow custom frontend URL via environment
]
